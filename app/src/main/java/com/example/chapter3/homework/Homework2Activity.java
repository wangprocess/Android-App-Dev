...
public class Homework2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startColorPicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ColorPicker picker = new ColorPicker(Homework2Activity.this);
        ...
        durationSelector.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new MaterialDialog.Builder(Homework2Activity.this)
    ...
    private void onDurationChanged(String input) {
        ...
        if (isValid) {
            ...
            Toast.makeText(Homework2Activity.this, R.string.invalid_duration, Toast.LENGTH_LONG).show();
        }
    }
